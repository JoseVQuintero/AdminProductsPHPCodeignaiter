...
function woocommerceproducts($products, $access, $id = null, $country = null, $operation = null){
    global $access_;
    ...
    try {
        ...
        foreach ($productsSeg as $products_) {
            ...
            $data_productos["create"] = [];
            $updateListProducts = []; 
            echo json_encode($updateListProducts);
            exit;
        }
    } catch (Exception $e) {
        var_dump($e);
...
function woocommerceproducts____($products,$access,$id=null,$country=null,$operation="create"){
    set_time_limit(0);
